...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("position", "localPosition", "eulerAngles", "localEulerAngles", "right", "up", "forward", "rotation", "localRotation", "localScale", "parent", "parentInternal", "hasChanged", "hierarchyCapacity", "name")]
